...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-6 -mb-6 flex flex-col-reverse gap-2 rounded-b-4xl border-t bg-muted/50 p-6 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
